...
const UserProfile = () => {
  ...
  const handleReviewSubmit = (id: number) => {
    toast({
      ...
      description:
        "Спасибо за ваш отзыв! Он поможет другим гостям выбрать ресторан.",
    });
  };
            ...
            <TabsContent value="settings">
              ...
              <Card className="border-border">
                <CardHeader>
                  ...
                  <CardDescription>
                    Удаление аккаунта приведет к потере всех данных и истории
                    бронирований
                  </CardDescription>
                </CardHeader>
                <CardContent>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Это действие невозможно отменить. Вы потеряете все данные, включая
              историю бронирований и настройки профиля.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
