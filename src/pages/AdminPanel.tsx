...
const AdminPanel = () => {
  ...
  const [addDishDialog, setAddDishDialog] = useState({
    open: false,
    categoryId: null,
  });
  const [editDishDialog, setEditDishDialog] = useState({
    open: false,
    categoryId: null,
    dishId: null,
  });
  ...
  return (
    <div className="container mx-auto px-4 py-8">
                          ...
                          <TableCell>
                            <div className="flex space-x-1">
                              ...
                              <Button
                                ...
                                className="h-8 w-8"
                                onClick={() =>
                                  handleOpenEditBooking(booking.id)
                                }
                              >
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                      ...
                      <div className="border border-dashed border-border rounded-md h-40 flex flex-col items-center justify-center">
                        <Button variant="ghost" onClick={handleAddPhoto}>
                    ...
                    <div className="space-y-6">
                      {dishes.map((category) => (
                        <div key={category.id}>
                                ...
                                <CardContent className="p-4">
                                  ...
                                  <div className="flex justify-end mt-2">
                                    <Button
                                      ...
                                      className="h-8 px-2"
                                      onClick={() =>
                                        handleEditDish(category.id, item.id)
                                      }
                                    >
                                      <Edit className="h-4 w-4" />
                                    </Button>
                                    <Button
                                      ...
                                      onClick={() =>
                                        handleRemoveDish(category.id, item.id)
                                      }
                                    >
                                      <X className="h-4 w-4" />
                                    </Button>
                          ...
                          {category.id !== dishes[dishes.length - 1].id && (
      ...
      <Dialog
        ...
        onOpenChange={(open) =>
          setEditBookingDialog({ ...editBookingDialog, open })
        }
      >
        <DialogContent>
          <DialogHeader>
      ...
      <Dialog
        ...
        onOpenChange={(open) =>
          setEditTableDialog({ ...editTableDialog, open })
        }
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              Настройка столика #{editTableDialog.tableId}
            </DialogTitle>
            <DialogDescription>Измените параметры столика</DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="space-y-2">
          ...
          <DialogFooter>
            <Button
              type="button"
              variant="outline"
              onClick={() => setEditTableDialog({ open: false, tableId: null })}
            >
              Отмена
            </Button>
        ...
        <DialogContent>
          ...
          <DialogFooter>
            <Button
              type="button"
              variant="outline"
              onClick={() => setAddTableDialog(false)}
            >
              Отмена
            </Button>
      ...
      <Dialog
        open={editDishDialog.open}
        onOpenChange={(open) =>
          setEditDishDialog({
            ...editDishDialog,
            open,
            categoryId: open ? editDishDialog.categoryId : null,
            dishId: open ? editDishDialog.dishId : null,
          })
        }
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Измените информацию о блюде</DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="space-y-2">
      ...
      <Dialog
        open={addDishDialog.open}
        onOpenChange={(open) =>
          setAddDishDialog({
            ...addDishDialog,
            open,
            categoryId: open ? addDishDialog.categoryId : null,
          })
        }
      >
        <DialogContent>
      ...
      <Dialog
        ...
        onOpenChange={(open) =>
          setEditCategoryDialog({
            ...editCategoryDialog,
            open,
            categoryId: open ? editCategoryDialog.categoryId : null,
          })
        }
      >
        <DialogContent>
